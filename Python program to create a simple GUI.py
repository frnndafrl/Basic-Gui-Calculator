...
if __name__ == "__main__":
    ...
    expression_field.grid(rowspan=2,column=0, columnspan=5,sticky='EW', ipadx=70) #
    ...
    button1.grid(row=2, column=0, pady=1)
    ...
    multiply = Button(gui, text=' X ', fg='black', bg='orange',
    ...
    kurangi = Button(gui, text=' <- ', fg='black', bg='orange',
                     command=lambda : backspace(), height=1, width=7)
    kurangi.grid(row=5, column=2)
